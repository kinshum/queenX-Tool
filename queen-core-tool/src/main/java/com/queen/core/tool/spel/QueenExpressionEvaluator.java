 ...
 * @author jensen
 */
public class QueenExpressionEvaluator extends CachedExpressionEvaluator {
	...
	public EvaluationContext createContext(Method method, Object[] args, Object target, Class<?> targetClass, @Nullable BeanFactory beanFactory) {
		...
		QueenExpressionRootObject rootObject = new QueenExpressionRootObject(method, args, target, targetClass, targetMethod);
