...
import com.queen.core.tool.function.CheckedFunction;
...
import com.queen.core.tool.utils.Unchecked;
	...
	public Object convert(Object value, Class target, final Object fieldName) {
		...
		try {
			...
			if (Map.class.isAssignableFrom(sourceClazz)) {
				...
				TypeDescriptor sourceDescriptor = QueenConverter.getTypeDescriptor(sourceClazz, (String) fieldName);
