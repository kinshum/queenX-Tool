...
import com.queen.core.tool.beans.BeanProperty;
import com.queen.core.tool.beans.QueenBeanCopier;
import com.queen.core.tool.beans.QueenBeanMap;
import com.queen.core.tool.convert.QueenConverter;
...
public class BeanUtil extends org.springframework.beans.BeanUtils {
	...
	public static <T> T copy(@Nullable Object source, Class sourceClazz, Class<T> targetClazz) {
		...
		QueenBeanCopier copier = QueenBeanCopier.create(sourceClazz, targetClazz, false);
	...
	public static void copy(@Nullable Object source, @Nullable Object targetBean) {
		...
		QueenBeanCopier copier = QueenBeanCopier
	...
	public static <T> T copyWithConvert(@Nullable Object source, Class<?> sourceClazz, Class<T> targetClazz) {
		...
		QueenBeanCopier copier = QueenBeanCopier.create(sourceClazz, targetClazz, true);
		T to = newInstance(targetClazz);
		copier.copy(source, to, new QueenConverter(sourceClazz, targetClazz));
		return to;
	}
	...
	public static Map<String, Object> toMap(@Nullable Object bean) {
		...
		return QueenBeanMap.create(bean);
	}
