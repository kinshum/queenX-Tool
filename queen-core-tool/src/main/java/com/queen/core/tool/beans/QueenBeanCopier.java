 ...
 * @author jensen
 */
public abstract class QueenBeanCopier {
	private static final Type CONVERTER = TypeUtils.parseType("org.springframework.cglib.core.Converter");
	private static final Type BEAN_COPIER = TypeUtils.parseType(QueenBeanCopier.class.getName());
	...
	/**
	 * The map to store {@link QueenBeanCopier} of source type and class type for copy.
	 */
	private static final ConcurrentMap<QueenBeanCopierKey, QueenBeanCopier> BEAN_COPIER_MAP = new ConcurrentHashMap<>();

	public static QueenBeanCopier create(Class source, Class target, boolean useConverter) {
		return QueenBeanCopier.create(source, target, useConverter, false);
	}

	public static QueenBeanCopier create(Class source, Class target, boolean useConverter, boolean nonNull) {
		QueenBeanCopierKey copierKey = new QueenBeanCopierKey(source, target, useConverter, nonNull);
	...
	public static class Generator extends AbstractClassGenerator {
		private static final Source SOURCE = new Source(QueenBeanCopier.class.getName());
		...
		@Override
		public QueenBeanCopier create(Object key) {
			return (QueenBeanCopier) super.create(key);
		}
