 ...
 *
 */
public class QueenHttpServletRequestWrapper extends HttpServletRequestWrapper {
	...
	public QueenHttpServletRequestWrapper(HttpServletRequest request) {
		super(request);
		orgRequest = request;
	}
	...
	public static HttpServletRequest getOrgRequest(HttpServletRequest request) {
		if (request instanceof QueenHttpServletRequestWrapper) {
			return ((QueenHttpServletRequestWrapper) request).getOrgRequest();
		}
		return request;
	}
